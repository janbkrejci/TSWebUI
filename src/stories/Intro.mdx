...
<table>
  ...
  <tbody>
    ...
    <tr><td>label</td><td>string</td><td>Zobrazovaný název sloupce</td></tr>
    ...
    <tr><td>width</td><td>string</td><td>Výchozí šířka (např. "120px")</td></tr>
    <tr><td>visible</td><td>boolean</td><td>Zda je sloupec viditelný</td></tr>
    <tr><td>clickable</td><td>boolean</td><td>Zda je sloupec klikatelný (pro eventy)</td></tr>
    <tr><td>format</td><td>string</td><td>Formátování hodnoty (např. "cz-date")</td></tr>
    <tr><td>...další</td><td>...</td><td>Další volitelné atributy</td></tr>
  </tbody>
</table>
