            ...
            tabs: [
                {
                    ...
                    rows: [
                        ...
                        [{ type: 'separator', label: 'Textarea (Rows 2)' }],
                        [{ field: 'textareaSmall' }],
                        [{ type: 'separator', label: 'Textarea (Rows 6)' }],
                        [{ field: 'textareaLarge' }]
                    ]
                },
                {
...
export const FileUploadWithDualLabels = {
    args: {
        ...defaultArgs,
        layout: JSON.stringify({
            rows: [
                [{ field: 'fileWithDualLabels', width: '1fr' }],
                [{ field: 'imageWithDualLabels', width: '1fr' }]
            ]
        }),
        fields: JSON.stringify({
            fileWithDualLabels: {
