...
- **type**: `'relationship'` (nebo `'relationship-picker'`)
...
<Story of={TSFORMStories.WithConfirmation} />
...
<Story of={TSFORMStories.Default} />
...
V této ukázce je pole `username` validní, zatímco pole `email` obsahuje chybu.

<Story of={TSFORMStories.ErrorExample} />
