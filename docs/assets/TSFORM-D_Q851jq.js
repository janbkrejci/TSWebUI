import{j as n,M as K}from"./blocks-D3nkoQsX.js";import{useMDXComponents as U}from"./index-5lGWLAE7.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-CvsoDv_z.js";/**
 * @license
...
\f\r]`,k=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,C=/-->/g,E=/>/g,g=RegExp(`>|${S}(?:([^\\s"'>=/]+)(${S}*=${S}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),O=/'/g,I=/"/g,R=/^(?:script|style|textarea|title)$/i,A=Symbol.for("lit-noChange"),h=Symbol.for("lit-nothing"),L=new WeakMap,v=b.createTreeWalker(b,129);function B(t,e){if(!H(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return M!==void 0?M.createHTML(e):e}const W=(t,e)=>{const i=t.length-1,s=[];let l,r=e===2?"<svg>":e===3?"<math>":"",o=k;for(let j=0;j<i;j++){const d=t[j];let a,x,c=-1,u=0;for(;u<d.length&&(o.lastIndex=u,x=o.exec(d),x!==null);)u=o.lastIndex,o===k?x[1]==="!--"?o=C:x[1]!==void 0?o=E:x[2]!==void 0?(R.test(x[2])&&(l=RegExp("</"+x[2],"g")),o=g):x[3]!==void 0&&(o=g):o===g?x[0]===">"?(o=l??k,c=-1):x[1]===void 0?c=-2:(c=o.lastIndex-x[2].length,a=x[1],o=x[3]===void 0?g:x[3]==='"'?I:O):o===I||o===O?o=g:o===C||o===E?o=k:(o=g,l=void 0);const p=o===g&&t[j+1].startsWith("/>")?" ":"";r+=o===k?d+Z:c>=0?(s.push(a),d.slice(0,c)+V+d.slice(c)+m+p):d+m+(c===-2?j:p)}return[B(t,r+(t[i]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),s]};class ${constructor({strings:e,_$litType$:i},s){let l;this.parts=[];let r=0,o=0;const j=e.length-1,d=this.parts,[a,x]=W(e,i);if(this.el=$.createElement(a,s),v.currentNode=this.el.content,i===2||i===3){const c=this.el.content.firstChild;c.replaceWith(...c.childNodes)}for(;(l=v.nextNode())!==null&&d.length<j;){if(l.nodeType===1){if(l.hasAttributes())for(const c of l.getAttributeNames())if(c.endsWith(V)){const u=x[o++],p=l.getAttribute(c).split(m),_=/([.?@])?(.*)/.exec(u);d.push({type:1,index:r,name:_[2],strings:p,ctor:_[1]==="."?G:_[1]==="?"?X:_[1]==="@"?Y:P}),l.removeAttribute(c)}else c.startsWith(m)&&(d.push({type:6,index:r}),l.removeAttribute(c));if(R.test(l.tagName)){const c=l.textContent.split(m),u=c.length-1;if(u>0){l.textContent=z?z.emptyScript:"";for(let p=0;p<u;p++)l.append(c[p],N()),v.nextNode(),d.push({type:2,index:++r});l.append(c[u],N())}}}else if(l.nodeType===8)if(l.data===F)d.push({type:2,index:r});else{let c=-1;for(;(c=l.data.indexOf(m,c+1))!==-1;)d.push({type:7,index:r}),c+=m.length-1}r++}}static createElement(e,i){const s=b.createElement("template");return s.innerHTML=e,s}}function f(t,e,i=t,s){if(e===A)return e;let l=s!==void 0?i._$Co?.[s]:i._$Cl;const r=y(e)?void 0:e._$litDirective$;return l?.constructor!==r&&(l?._$AO?.(!1),r===void 0?l=void 0:(l=new r(t),l._$AT(t,i,s)),s!==void 0?(i._$Co??=[])[s]=l:i._$Cl=l),l!==void 0&&(e=f(t,l._$AS(t,e.values),l,s)),e}class q{constructor(e,i){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:i},parts:s}=this._$AD,l=(e?.creationScope??b).importNode(i,!0);v.currentNode=l;let r=v.nextNode(),o=0,j=0,d=s[0];for(;d!==void 0;){if(o===d.index){let a;d.type===2?a=new w(r,r.nextSibling,this,e):d.type===1?a=new d.ctor(r,d.name,d.strings,this,e):d.type===6&&(a=new Q(r,this,e)),this._$AV.push(a),d=s[++j]}o!==d?.index&&(r=v.nextNode(),o++)}return v.currentNode=b,l}p(e){let i=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,i),i+=s.strings.length-2):s._$AI(e[i])),i++}}class w{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,i,s,l){this.type=2,this._$AH=h,this._$AN=void 0,this._$AA=e,this._$AB=i,this._$AM=s,this.options=l,this._$Cv=l?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&e?.nodeType===11&&(e=i.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,i=this){e=f(this,e,i),y(e)?e===h||e==null||e===""?(this._$AH!==h&&this._$AR(),this._$AH=h):e!==this._$AH&&e!==A&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):J(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==h&&y(this._$AH)?this._$AA.nextSibling.data=e:this.T(b.createTextNode(e)),this._$AH=e}$(e){const{values:i,_$litType$:s}=e,l=typeof s=="number"?this._$AC(e):(s.el===void 0&&(s.el=$.createElement(B(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===l)this._$AH.p(i);else{const r=new q(l,this),o=r.u(this.options);r.p(i),this.T(o),this._$AH=r}}_$AC(e){let i=L.get(e.strings);return i===void 0&&L.set(e.strings,i=new $(e)),i}k(e){H(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,l=0;for(const r of e)l===i.length?i.push(s=new w(this.O(N()),this.O(N()),this,this.options)):s=i[l],s._$AI(r),l++;l<i.length&&(this._$AR(s&&s._$AB.nextSibling,l),i.length=l)}_$AR(e=this._$AA.nextSibling,i){for(this._$AP?.(!1,!0,i);e!==this._$AB;){const s=e.nextSibling;e.remove(),e=s}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}}class P{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,i,s,l,r){this.type=1,this._$AH=h,this._$AN=void 0,this.element=e,this.name=i,this._$AM=l,this.options=r,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=h}_$AI(e,i=this,s,l){const r=this.strings;let o=!1;if(r===void 0)e=f(this,e,i,0),o=!y(e)||e!==this._$AH&&e!==A,o&&(this._$AH=e);else{const j=e;let d,a;for(e=r[0],d=0;d<r.length-1;d++)a=f(this,j[s+d],i,d),a===A&&(a=this._$AH[d]),o||=!y(a)||a!==this._$AH[d],a===h?e=h:e!==h&&(e+=(a??"")+r[d+1]),this._$AH[d]=a}o&&!l&&this.j(e)}j(e){e===h?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class G extends P{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===h?void 0:e}}class X extends P{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==h)}}class Y extends P{constructor(e,i,s,l,r){super(e,i,s,l,r),this.type=5}_$AI(e,i=this){if((e=f(this,e,i,0)??h)===A)return;const s=this._$AH,l=e===h&&s!==h||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,r=e!==h&&(s===h||l);l&&this.element.removeEventListener(this.name,this,s),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class Q{constructor(e,i,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){f(this,e)}}const ee=T.litHtmlPolyfillSupport;ee?.($,w),(T.litHtmlVersions??=[]).push("3.3.1");const{action:te}=__STORYBOOK_MODULE_ACTIONS__;function D(t){const e={code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...U(),...t.components};return n.jsxs(n.Fragment,{children:[n.jsx(K,{title:"TSWebUI/TSForm"}),`
...
`})})]})}function re(t={}){const{wrapper:e}={...U(),...t.components};return e?n.jsx(e,{...t,children:n.jsx(D,{...t})}):D(t)}export{re as default};
