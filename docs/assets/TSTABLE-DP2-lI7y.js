...
`,e.jsx(n.p,{children:"UNLICENSED – dělejte si s tím co chcete, ale nic po mně nechtějte :-)"})]})}function a(l={}){const{wrapper:n}={...d(),...l.components};return n?e.jsx(n,{...l,children:e.jsx(t,{...l})}):t(l)}export{a as default};
