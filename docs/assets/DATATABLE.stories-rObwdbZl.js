const r=`<div class="sl-theme-{{theme}} base-container main-container">
    <script>
        ...
        // Actions for Selection dropdown in toolbar (CZ)
        const selectionMenuItems = [
            // singleOnly items appear only when exactly one row is selected
            { name: 'edit', title: 'Upravit záznam', singleOnly: true },
            { name: 'duplicate', title: 'Duplikovat záznam', singleOnly: true },
            // multi-capable items appear for any selection count >= 1
            { name: 'delete', title: 'Smazat vybrané', singleOnly: false },
            { name: 'export', title: 'Exportovat vybrané', singleOnly: false }
        ];
